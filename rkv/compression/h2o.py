...
class H2O:
    ...
    def update_kv(
        ...
        if kv_cache_len < self.budget:
            ...
            # print(attn_weights.shape, attn_weights_sum.shape) # torch.Size([1, 8, 248]) torch.Size([1, 247])
            ...
            # print(indices.shape) # torch.Size([1, 127])
            ...
            # print(k_past_compress.shape, k_cur.shape) # torch.Size([1, 1, 127, 128]) torch.Size([1, 8, 1, 128])
