...
class Scheduler(SchedulerInterface):
        ...
        while req_index < len(self.running) and token_budget > 0:
            ...
            while True:
                ...
                if new_blocks is None:
                    ...
                    preempted_req.num_dropped_tokens = 0
                    if self.log_stats:
    ...
    def _make_cached_request_data(
        ...
        for req in itertools.chain(running_reqs, resumed_reqs):
            ...
            num_dropped_tokens_list.append(min(req.num_dropped_tokens, req.num_computed_tokens))
    ...
    def update_from_output(
        ...
        for req_id, num_tokens_scheduled in num_scheduled_tokens.items():
            ...
            if request.num_dropped_tokens > request.num_computed_tokens:
                request.num_dropped_tokens = request.num_computed_tokens
